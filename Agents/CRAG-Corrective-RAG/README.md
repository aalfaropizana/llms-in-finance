...
1. GPT-4o was intentionally not used with LlamaParse during initial development to evaluate the quality of CRAG independently of parsing quality. Further evaluation is planned.
2. Small modifications have been made to the CorrectiveRAGPack to facilitate visualization of intermediate results.

## About the Maintainer

This project is actively maintained by **Ana Pizana**, an AI & LLM Engineer.

Ana brings over 4 years of professional experience in AI and LLM applications, with a strong background in:
