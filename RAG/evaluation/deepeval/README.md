...
- All these metrics use an LLM alongside designated prompts to extract statements/claims from the element you want to evaluate in your LLM application, such as the generated answer.
- And then they assert whether the extracted information (Statement/claim) is aligned with or can be inferred from the retrieved context for example.
...
This project is currently maintained by Ana Pizana.

**Ana Pizana**
AI & LLM Engineer

Ana is an AI & LLM Engineer with over 4 years of professional experience, specializing in the development and evaluation of large language model applications. She is dedicated to advancing robust and reliable AI systems.

**Key Skills:** Python, PostgreSQL, Rust, JAVA, NumPy, Pandas, MatLab, TensorFlow, Scikit-learn, NLTK, PyTorch
